...
static VALID_SYLLABLES: &[&str] = &[
    ...
    "bin", "bing", "bu", "pa", "po", "pai", "pei", "pao", "pou", "pan", "pen", "pang", "peng",
    "pi", "pie", "piao", "pian", "pin", "ping", "pu", "ma", "mo", "me", "mai", "mei", "mao", "mou",
    "man", "men", "mang", "meng", "mi", "mie", "miao", "miu", "mian", "min", "ming", "mu", "fa",
    "fo", "fei", "fou", "fan", "fen", "fang", "feng", "fu", "da", "de", "dai", "dei", "dao", "dou",
    "dan", "den", "dang", "deng", "di", "die", "diao", "diu", "dian", "ding", "dong", "du", "duo",
    "duan", "dun", "ta", "te", "tai", "tei", "tao", "tou", "tan", "tang", "teng", "ti", "tie",
    "tiao", "tian", "ting", "tong", "tu", "tuo", "tuan", "tun", "na", "ne", "nai", "nei", "nao",
    "nou", "nan", "nen", "nang", "neng", "ni", "nie", "niao", "niu", "nian", "nin", "niang",
    "ning", "nong", "nu", "nuo", "nuan", "nv", "nve", "nün", "nüe", "la", "le", "lai", "lei", "lao", "lou",
    "lan", "len", "lang", "leng", "li", "lia", "lie", "liao", "liu", "lian", "lin", "liang",
    "ling", "long", "lu", "luo", "luan", "lun", "lv", "lve", "lü", "lüe", "ga", "ge", "gai", "gei", "gao",
    "gou", "gan", "gen", "gang", "geng", "gong", "gu", "gua", "guai", "gui", "guan", "gun",
    "guang", "guo", "ka", "ke", "kai", "kei", "kao", "kou", "kan", "ken", "kang", "keng", "kong",
    "ku", "kua", "kuai", "kui", "kuan", "kun", "kuang", "ha", "he", "hai", "hei", "hao", "hou",
    "han", "hen", "hang", "heng", "hong", "hu", "hua", "huai", "hui", "huan", "hun", "huang", "ji",
    "jia", "jie", "jiao", "jiu", "jian", "jin", "jiang", "jing", "jiong", "ju", "jue", "jun",
    "juan", "qi", "qia", "qie", "qiao", "qiu", "qian", "qin", "qiang", "qing", "qiong", "qu",
    "que", "qun", "quan", "xi", "xia", "xie", "xiao", "xiu", "xian", "xin", "xiang", "xing",
    "xiong", "xu", "xue", "xun", "xuan", "zhi", "zha", "zhe", "zhai", "zhei", "zhao", "zhou",
    "zhan", "zhen", "zhang", "zheng", "zhong", "zhu", "zhua", "zhuai", "zhui", "zhuan", "zhun",
    "zhuang", "chi", "cha", "che", "chai", "chao", "chou", "chan", "chen", "chang", "cheng",
    "chong", "chu", "chua", "chuai", "chui", "chuan", "chun", "chuang", "shi", "sha", "she",
    "shai", "shei", "shao", "shou", "shan", "shen", "shang", "sheng", "shu", "shua", "shuai",
    "shui", "shuan", "shun", "shuang", "ri", "re", "rao", "rou", "ran", "ren", "rang", "reng",
    "rong", "ru", "rua", "rui", "ruan", "run", "za", "ze", "zai", "zei", "zao", "zou", "zan",
    "zen", "zang", "zeng", "zong", "zu", "zuo", "zuan", "zun", "ca", "ce", "cai", "cao", "cou",
    "can", "cen", "cang", "ceng", "cong", "cu", "cuo", "cuan", "cun", "sa", "se", "sai", "sao",
    "sou", "san", "sen", "sang", "seng", "song", "su", "suo", "suan", "sun", "ya", "yo", "ye",
    "yao", "you", "yan", "yin", "yang", "ying", "yong", "yu", "yue", "yun", "yuan", "wa", "wo",
    "wai", "wei", "wan", "wen", "wang", "weng", "wu", "a", "o", "e", "ai", "ei", "ao", "ou", "an",
    "en", "ang", "eng", "er", "yi", "wu", "yu",
];
        ...
        for initial in INITIALS {
            if let Some(rest) = s.strip_prefix(initial) {
                if !rest.is_empty() && FINALS.contains(&rest) {
                    return Some(Self::new(Some(initial.to_string()), rest.to_string(), 0));
                }
            }
        }
